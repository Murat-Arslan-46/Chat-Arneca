...
interface SharedDao {
    ...
    @Query("select * from messageDB where send = 0")
    fun getMessageWithSendFalse() : LiveData<List<EntityMessage>>
    ...
    fun getMessageLastForChatList() : LiveData<List<EntityMessage>>
